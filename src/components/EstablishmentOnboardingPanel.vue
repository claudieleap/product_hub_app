...
import { ONBOARDING_PROJECTS, ONBOARDING_PEOPLE } from '@/config/onboardingConfig';
...
const { getCard, updateCard, addUnit, removeUnit, addConvenio, removeConvenio, readCell, cardProgress } = useOnboardingBoard();
...
<template>
    ...
    <p v-else class="com-comment-empty">Este estabelecimento ainda não entrou no board de Onboarding.</p>
</template>
